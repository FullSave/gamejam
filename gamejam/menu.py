...
class Menu(object):
    ...
    def __init__(self):
        ...
        SpriteSheet().add_sprite("chicken_front", Sprite(128, 144, 32, 32, 7))
        SpriteSheet().add_sprite("chicken_right", Sprite(160, 144, 32, 32, 7))
        SpriteSheet().add_sprite("chicken_back", Sprite(192, 144, 32, 32, 7))
        SpriteSheet().add_sprite("chicken_left", Sprite(224, 144, 32, 32, 7))
